          ...
          <div class="timeline-item" data-aos="fade-up">
            ...
            <div class="timeline-content">
              ...
              <p>
                ...
                համակարգչային հավելվածներ և ծրագրեր: Cloud-ի մասնագետները կարող
                են օգտագործել նույն ծրագրակազմն ու գործիքները՝ դրանք ստեղծելու
                համար, ինչպես ՏՏ մյուս մշակողները: Այնուամենայնիվ, ռեսուրսները,
                որոնք օգտագործվում են այս մասնագետների կողմից, վերցված են
                cloud-based հարթակից:
              </p>
            </div>
          </div>
        </div>
